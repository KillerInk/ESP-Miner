...
void auto_tune_init()
{
    AUTO_TUNE.frequency = nvs_config_get_u16(NVS_CONFIG_ASIC_FREQUENCY_FLOAT, AUTO_TUNE.frequency);
...
{
    return POWER_MANAGEMENT_MODULE.chip_temp_avg > AUTO_TUNE.max_temp_asic ||
