...
static void generate_work(mining_notify * notify,uint32_t extranonce_2);
...
void create_jobs_task(void *pvParameters)
{
    ...
    while (1)
    {
        ...
        while (GLOBAL_STATE.stratum_queue.count < 1 && GLOBAL_STATE.abandon_work == 0)
        {
            ...
            {
                generate_work(mining_notification, extranonce_2);
...
static void generate_work(mining_notify *notification , uint32_t extranonce_2)
{
